...
'<div id=mywindow><img src="%27+windowNONEgrf+%27.html" width=100% height=20></div>                                                                                                             	'+ '\n'+
...
'<div id=mywindowCLOSE><img name=closewin src="%27+%20windowCERRARd%20+%27.html" border=0 width=11 height=11></div>                                                                                  '+ '\n'+
'<div id=mywindowCLOCK><img name=clockwin src="%27+%20windowCLOCK%20%20%20+%27.html" border=0 width=11 height=11></div>                                                                                  '+ '\n'+
'</body>                                                                                                                                                                        	'+ '\n'+
...
'		<frame name=main       src="%27+theURL+%27.html">                   									'+ '\n'+
...
'</HTML>                                                                        								'
		...
		var splashWin = window.open(theURL, wname, "fullscreen=no,toolbar=no,status=no,menubar=no,scrollbars=yes,resizable=no,directories=no,location=no"+s, true);
	}
